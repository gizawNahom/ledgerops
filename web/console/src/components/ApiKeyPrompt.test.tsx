...
describe("ApiKeyPrompt -- the operator pastes a key once per browser", () => {
  it("submitting a pasted key hands it to the console to store and retry", async () => {
  ...
  it("the pasted key is never shoulder-surfable -- masked input, not plain text", () => {
  ...
  it("@error a rejected key re-shows the form with an inline explanation, not the blank first-load prompt", () => {
