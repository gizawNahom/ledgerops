...
Feature: The store keeps the promises the application layer cannot
  ...
  @pending @append-only @contract-shape:unbounded-preservation
  ...
  @pending @env-populated @contract-shape:bounded-change
  ...
  @pending @env-contended @contract-shape:bounded-change
